...
class NavigationPage(BasePage):
    ...
    def navigateToUserSettings(self):
        userSettingsElement = self.waitForElement(locator="//div[@id='navbar']//li[@class='dropdown']",
                                      locatorType="xpath", pollFrequency=1)
        # self.elementClick(element=userSettingsElement)

        self.elementClick(locator="//div[@id='navbar']//li[@class='dropdown']", locatorType="xpath")